...
InputControlType.CONTINUOUS : [Single Press (0 ... 1)]
    ...
    - InputSingleBinding : InputControl : <Device/Path>

InputControlType.AXIS :

    - InputSingleBinding : InputControl : <Device/Path> // Ex. Joystick movement.
...
InputControlType.VECTOR_3 :
    ...
    - InputSingleBinding : InputControl : <Device/Path> // Ex. Gyroscope rotation.
